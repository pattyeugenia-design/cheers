...
const translations = {
  es: {
    ...
    plans: [
      { name: 'Cheer', price: '$0', sub: 'para siempre', features: ['1 celebración activa', 'Hasta 3 invitados', 'Itinerario básico'], cta: 'Empezar gratis', featured: false },
  ...
  en: {
    ...
    plans: [
      { name: 'Cheer', price: '$0', sub: 'forever', features: ['1 active celebration', 'Up to 3 guests', 'Basic itinerary'], cta: 'Start free', featured: false },
      { name: 'Super Cheer', price: '$9', sub: 'per celebration', features: ['Up to 10 guests', 'Full itinerary', 'Gift list', 'Surprise mode', 'Personalization'], cta: 'Start with Super Cheer', featured: true, badge: 'MOST POPULAR' },
      { name: 'Extra Cheer', price: '$49', sub: 'one-time · forever', features: ['Unlimited guests', 'Public link for open events', 'Full history', 'Everything included'], cta: 'Buy Extra Cheer', featured: false },
    ],
