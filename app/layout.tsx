...
const destellos = [
  ...
  { left: '2%',  top: '46%', size: 26, delay: '2.6s', dur: '3.1s' },
  { left: '14%', top: '58%', size: 8,  delay: '0.1s', dur: '2.9s' },
  { left: '26%', top: '31%', size: 40, delay: '1.4s', dur: '2.4s' },
  { left: '35%', top: '62%', size: 14, delay: '0.6s', dur: '3.6s' },
  { left: '46%', top: '18%', size: 8,  delay: '2.0s', dur: '2.7s' },
  { left: '50%', top: '80%', size: 32, delay: '1.1s', dur: '3.3s' },
  { left: '62%', top: '33%', size: 10, delay: '0.4s', dur: '2.6s' },
  { left: '70%', top: '63%', size: 48, delay: '1.7s', dur: '3.9s' },
  { left: '80%', top: '48%', size: 12, delay: '0.9s', dur: '2.5s' },
  { left: '88%', top: '33%', size: 20, delay: '2.3s', dur: '3.2s' },
  { left: '96%', top: '70%', size: 9,  delay: '0.5s', dur: '3.7s' },
  { left: '96%', top: '10%', size: 16, delay: '1.3s', dur: '2.8s' },
  { left: '1%',  top: '78%', size: 34, delay: '0.8s', dur: '3.4s' },
  { left: '8%',  top: '95%', size: 12, delay: '2.1s', dur: '2.6s' },
  { left: '22%', top: '96%', size: 8,  delay: '0.3s', dur: '3.5s' },
  { left: '40%', top: '30%', size: 9,  delay: '1.9s', dur: '2.9s' },
  { left: '58%', top: '62%', size: 8,  delay: '0.6s', dur: '3.1s' },
  { left: '86%', top: '65%', size: 18, delay: '1.5s', dur: '2.4s' },
  { left: '96%', top: '48%', size: 40, delay: '0.2s', dur: '3.8s' },
]
